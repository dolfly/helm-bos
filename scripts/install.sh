...
echo "Installing helm-bos ${version} ..."
...
url="https://github.com/dolfly/helm-bos/releases/download/${version}/helm-bos_${version}_${os}_${arch}.tar.gz"
...
echo "helm-bos ${version} is correctly installed."
echo

echo "Init a new repository:"
echo "  helm bos init bos://bucket/path"
echo

echo "Add your repository to Helm:"
echo "  helm repo add repo-name bos://bucket/path"
echo

echo "Push a chart to your repository:"
echo "  helm bos push chart.tar.gz repo-name"
echo
